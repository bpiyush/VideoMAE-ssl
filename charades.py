"""Defines Charades dataset class."""
import os
import numpy as np
import torch
...
class CharadesVideoMultiClsDataset(Dataset):
    ...
    def __init__(self, anno_path, data_path, mode='train', clip_len=8,
        ...
        self.dataset_samples = list(cleaned.id.values)
        self.label_array = [eval(x) for x in list(cleaned.classes.values)]
    ...
    def get_fname_from_sample(self, sample):
    ...
    def loadvideo_decord(self, sample, sample_rate_scale=1):
        ...
        # fname = sample
        fname = self.get_fname_from_sample(sample)
...
if __name__ == "__main__":
    ...
    dataset = CharadesVideoMultiClsDataset(
        anno_path='/var/scratch/pbagad/datasets/Charades/annotations/Charades_v1_train_videomae.csv',
        data_path='/var/scratch/pbagad/datasets/Charades/Charades_v1_480',
        args=args,
    )
    frame_list, label_list, index_list, _ = dataset[0]
